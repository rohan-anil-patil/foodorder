        ...
        <section class="home" id="home">
            <div class="container">
                <div class="home-wrapper d-grid">
                    <div class="col-left">
                        <h3>Welcome TO</h3>
                        <h1>Online Food <br>Ordering System</h1>

                        <p>Don't waste time on hold - order your favorite meal with just a few clicks using our easy online system.
Craving something specific? Our customizable menu options make it easy to get exactly what you want. </p>
